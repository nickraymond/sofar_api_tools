# filename: sofar_api_parsin_v3.py
...
#spotterId = "SPOT-31380C" # BM Camera unit
spotterId = "SPOT-31088C" ## HMB unit
#spotterId = "SPOT-31817C" ## IQT unit
...
# Define start and end dates for API request, limited to 500x Spotter calls
#start_date = "2024-11-10T00:00:00Z"
#end_date = "2024-11-19T00:00:00Z"

# Define the number of days before today for the start_date
days_before = 8  # Change this to 7 or any number of days you want

# Get the current UTC time
now = datetime.utcnow()

# Calculate the start_date and end_date
start_date = (now - timedelta(days=days_before)).strftime("%Y-%m-%dT%H:%M:%SZ")
...
api_url_spotter_waves = (
    ...
    f"&endDate={end_date}&token={token}&includeWindData=true&includeSurfaceTempData=true&includeBarometerData=true&limit=500&processingSources=all"
)
