# filename: raw_decode_complete.py
...
# Set up API URLs
api_url_smart_mooring = f"https://api.sofarocean.com/api/sensor-data?spotterId={spotterId}&startDate={start_date}&endDate={end_date}&token={token}"
api_url_spotter_waves = (
    f"https://api.sofarocean.com/api/wave-data?spotterId={spotterId}&startDate={start_date}"
    f"&endDate={end_date}&token={token}&includeWindData=true&includeSurfaceTempData=true&includeBarometerData=true"
)
